...
from q_function import q_rng_lotto, get_rng_lotto
from q_function import q_rng_lotto_with_birthday, get_rng_lotto_with_birthday
...
################################### Powerball(USA) #####################################################################
    ...
    if mode == '1) Simple Q-RNG':
        ...
        birth_day = st.date_input(
            ...
            datetime.datetime.today(), min_value=datetime.date(1918, 5, 11),  # Feynman's birthday
